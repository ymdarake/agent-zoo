...
| 優先度 | タスク | アクション |
|---|---|---|
| P0 | **#29 .zoo/ 集約 refactor** | [ADR 0002](docs/adr/0002-dot-zoo-workspace-layout.md) に基づき zoo CLI / docker-compose / runner / init を再設計。✅ D8 candidate 完全削除は先行完了（2026-04-18）|
