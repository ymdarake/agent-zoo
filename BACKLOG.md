...
| 優先度 | タスク | アクション |
|---|---|---|
| P0 | **#29 .zoo/ 集約 refactor** | [ADR 0002](docs/adr/0002-dot-zoo-workspace-layout.md) に基づき zoo CLI / docker-compose / runner / init を再設計。policy_candidate.toml は事前削除（D8）|
...
- 先行クリーンアップ: policy_candidate.toml 完全削除（リリース前のため互換不要）
