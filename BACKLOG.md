...
| 優先度 | タスク | アクション |
|---|---|---|
| P0 | **#29 .zoo/ 集約 refactor** | [ADR 0002](docs/adr/0002-dot-zoo-workspace-layout.md) に基づき zoo CLI / docker-compose / runner / init を再設計。✅ D8 candidate 完全削除 / ✅ Phase 0+1（D7 詳細化・workspace_root/zoo_dir 追加・gitignore template） / ✅ Phase 2（init() を target/.zoo/ 配下展開、Makefile 配布廃止）。次: Phase 3-6 の breaking 切替（docker-compose / source repo migration） |
